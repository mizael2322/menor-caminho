...
class TestGrafo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.g_p_com_peso.adiciona_aresta("a1", "J", "C", 3)
        self.g_p_com_peso.adiciona_aresta("a2", "C", "E", 5)
        self.g_p_com_peso.adiciona_aresta("a3", "C", "E", 1)
        self.g_p_com_peso.adiciona_aresta("a4", "C", "P", 7)
        self.g_p_com_peso.adiciona_aresta("a5", "C", "P", 3)
        self.g_p_com_peso.adiciona_aresta("a6", "C", "T", 10)
        self.g_p_com_peso.adiciona_aresta("a7", "C", "M", 3)
        self.g_p_com_peso.adiciona_aresta("a8", "T", "M", 1)
        self.g_p_com_peso.adiciona_aresta("a9", "T", "Z", 6)
    ...
    def test_dijkstra(self):
        ...
        #com peso
        self.assertEqual(self.g_p_com_peso.dijkstra('C', 'E'), ['C', 'a3', 'E'])
        self.assertEqual(self.g_p_com_peso.dijkstra('C', 'P'), ['C', 'a5', 'P'])
        self.assertEqual(self.g_p_com_peso.dijkstra('C', 'T'), ['C', 'a7', 'M', 'a8', 'T'])
        self.assertEqual(self.g_p_com_peso.dijkstra('C', 'M'), ['C', 'a7', 'M'])
        self.assertEqual(self.g_p_com_peso.dijkstra('C', 'Z'), ['C', 'a7', 'M', 'a8', 'T', 'a9', 'Z'])
        self.assertEqual(self.g_p_com_peso.dijkstra('E', 'P'), ['E', 'a3', 'C', 'a5', 'P'])
        self.assertEqual(self.g_p_com_peso.dijkstra('E', 'T'), ['E', 'a3','C', 'a7', 'M', 'a8', 'T'])
        self.assertEqual(self.g_p_com_peso.dijkstra('E', 'M'), ['E', 'a3','C', 'a7', 'M'])
        self.assertEqual(self.g_p_com_peso.dijkstra('E', 'Z'), ['E', 'a3','C', 'a7', 'M', 'a8', 'T', 'a9', 'Z'])
        self.assertEqual(self.g_p_com_peso.dijkstra('P', 'E'), ['P', 'a5', 'C', 'a3', 'E'])
        self.assertEqual(self.g_p_com_peso.dijkstra('P', 'T'), ['P', 'a5', 'C', 'a7', 'M', 'a8', 'T'])
        self.assertEqual(self.g_p_com_peso.dijkstra('P', 'M'), ['P', 'a5', 'C', 'a7', 'M'])
        self.assertEqual(self.g_p_com_peso.dijkstra('P', 'Z'), ['P', 'a5', 'C', 'a7', 'M', 'a8', 'T', 'a9', 'Z'])
        self.assertEqual(self.g_p_com_peso.dijkstra('T', 'E'), ['T', 'a8', 'M','a7','C', 'a3', 'E'])
        self.assertEqual(self.g_p_com_peso.dijkstra('T', 'P'), ['T', 'a8', 'M', 'a7', 'C', 'a5', 'P'])
        self.assertEqual(self.g_p_com_peso.dijkstra('T', 'M'), ['T', 'a8', 'M'])
        self.assertEqual(self.g_p_com_peso.dijkstra('T', 'Z'), ['T', 'a9', 'Z'])
        self.assertEqual(self.g_p_com_peso.dijkstra('M', 'E'), ['M', 'a7', 'C', 'a3', 'E'])
        self.assertEqual(self.g_p_com_peso.dijkstra('M', 'P'), ['M', 'a7', 'C', 'a5', 'P'])
        self.assertEqual(self.g_p_com_peso.dijkstra('M', 'T'), ['M', 'a8', 'T'])
        self.assertEqual(self.g_p_com_peso.dijkstra('M', 'Z'), ['M', 'a8', 'T', 'a9', 'Z'])
        self.assertEqual(self.g_p_com_peso.dijkstra('Z', 'E'), ['Z', 'a9', 'T', 'a8', 'M','a7','C', 'a3', 'E'])
        self.assertEqual(self.g_p_com_peso.dijkstra('Z', 'P'), ['Z', 'a9', 'T', 'a8', 'M', 'a7', 'C', 'a5', 'P'])
        self.assertEqual(self.g_p_com_peso.dijkstra('Z', 'M'), ['Z', 'a9', 'T', 'a8', 'M'])
        self.assertEqual(self.g_p_com_peso.dijkstra('Z', 'T'), ['Z', 'a9', 'T'])
        #desconexo
